...
public class variablesControlador implements Serializable {
    ...
    public void registrarVariables(Empleado em) {
        ...
        //éste método no se usa en ninguna vista que se muestre en el ststema
    ...
    public void registrarVariablesQuemador() {
        ...
        try {
            ...
            // Se captura los parametro de los input en un objeto de variables
    ...
    public void validacionEstadoRegistro() throws IOException {
        ...
        // Éste método es para validar si el estado del registro para 
    ...
    public void generarReporte() throws ParseException {
        ...
        // Variable que recibe la fecha del input y la frormatea
        ...
        // Recorre e imprime todos los registros
    ...
    public void generarReportesEntreFechas() throws ParseException {
        ...
        // Variable que formatea la fecha y los strings que reciben el valor de los input tipo date
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        ...
        try {
            ...
            for (int i = 0; i < variablesQuemador.size(); i++) {
                ...
                // Obtener los registro entre sus fechas segun los parametros
            ...
            //Validación de estado para mostrar un mensaje
    ...
    public void editarVariableQuemador() {
        ...
        // Variables globales del método (Significa variables que se usan en todo el metodo)
        ...
        try {
            ...
            // Conversión de datos de los input en un objeto para editar
            // Formula para calcular el porcentaje de toneladas
            numero = Double.parseDouble((String) params.get("toneladas"));
            numero = numero * 0.0066666666666667;
            numero = numero * 100;
            numero = Math.round(numero);
            ...
            // Si el campo de el empleado está vacio significa que no 
            //se hizo ningun cambio de quién registro las variables, sino se hará la respetiva edición
    ...
    public String cargarAtributoEditar(Variablesquemador variable) {
        ...
        // se carga el atributo antes de entrar a la vista para que muestre los datos correspondientes
